...
function fetchWeatherData() {
    fetch(`http://api.weatherapi.com/v1/current.json?key=686088f4f4a34d4ab1821205242106&q=${cityInput}`) 
        ...
        .then(data => {
           ...
           let  th=time.split(":")[0];
            if(th>12){
                th = th - 12;
                let res = th + ":" + time.split(":")[1];
                timeOutput.innerHTML = res;
            }
            else  {timeOutput.innerHTML = time;
             }
            ...
            if (code === 1000) { 
                icon.src="./icons/day/clear.png";
                app.style.backgroundImage = `url(./images/${timeOfDay}/clear.jpg)`;
                btn.style.background = "#e5ba92";

            if (timeOfDay === "night") {
                icon.src="./icons/night/clear.png"
